...
A comprehensive reference of **810** real-world DeFi security incidents (2020–2026), with root cause analysis, attack flow diagrams, on-chain source code, and PoC exploit code.
...
| [Business Logic](./vulns/business-logic.md) | 134 | Protocol-specific flaws in accounting, rewards, or invariants |
| [Oracle & Price Manipulation](./vulns/oracle-price-manipulation.md) | 96 | Spot price distortion, reserve skewing, TWAP gaming |
| [Access Control](./vulns/access-control.md) | 95 | Missing or bypassed permission checks on privileged functions |
| [Reentrancy](./vulns/reentrancy.md) | 61 | Cross-function and read-only reentrancy attacks |
| [Arbitrary Call / Input](./vulns/arbitrary-call.md) | 73 | Attacker-controlled calldata hijacking execution flow |
| [Staking & Reward](./vulns/staking-reward.md) | 45 | Reward math errors, lock-up bypass, vault logic flaws |
| [Integer & Precision](./vulns/integer-precision.md) | 26 | Overflow, underflow, and fixed-point precision bugs |
...
| [Private Key Compromise](./vulns/private-key-compromise.md) | 11 | Key theft, GitHub leak, insider abuse, supply chain attacks |
